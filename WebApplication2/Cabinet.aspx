    ...
    <div class="container">
        ...
        %>
            <div class="content">
                ...
                <asp:GridView class="full-table" ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="LinqDataSource1" AllowPaging="True" DataKeyNames="номер_почтового_отправления" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellPadding="4" ForeColor="#333333" GridLines="None">
